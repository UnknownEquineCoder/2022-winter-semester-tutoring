...
huge_list = [
    "Fabian", "Alberto", "Osvaldo",
    "Branson", "Benjamin", "Demarion",
    "Dylan", "Kason", "Kellen", "Armando",
    "Semaj", "Konnor", "Ralph", "Salvador",
    "Deshawn", "Eduardo", "Jude", "Devon",
    "Ronnie", "Cristopher", "Arjun", "Jasiah",
    "Rex", "Blaze", "Ace", "Dominique", "Tobias",
    "Jorden", "Mohammed", "Aaron", "Robert",
    "Jace", "Owen", "Trey", "Luke", "Holden",
    "Ramiro", "Lawrence", "Miles", "Kareem",
    "Kyler", "Geovanni", "Andy", "Leonel", "Alijah",
    "Lewis", "Malaki", "Donavan", "Kolten", "Liam",
    "Neil", "Layton", "Stephen", "Davion", "Victor",
    "Santos", "Yurem", "Kobe", "Douglas", "Jessie",
    "Jayvon", "Cael", "Joshua", "Tony", "Lee",
    "Titus", "Mason", "Raul", "Jordan", "Dustin",
    "Brennen", "Jayson", "Kymani", "Dallas",
    "Charlie", "Rayan", "Boston", "Justin", "Ricky",
    "Hugh", "Gael", "Finley", "Jamari", "Conor",
    "Armani", "Orlando", "Kamden", "Augustus",
    "Trevon", "Marvin", "Jadon", "Yosef", "Aldo",
    "Brice", "Deacon", "Santino", "Aditya", "Rudy",
    "Noah", "Ulises",
]
...
names_and_emails = [("Marcel", "m-repr@uniacad.net"),
...
names_and_emails_set = {("Marcel", "m-repr@uniacad.net"),
                        ("John", "jlofan@spotifive.com"),
                        ("Nick", "nick@lesscage.at"),
                        ("Kamala", "kharris@vpotus.gov"),
                        ("Deepak", "admin@responsibility.at")}
...
names_and_emails_dictionary = {"Marcel": "m-repr@uniacad.net",
                               "John": "jlofan@spotifive.com",
                               "Nick": "nick@lesscage.at",
                               "Kamala": "kharris@vpotus.gov",
                               "Deepak": "admin@responsibility.at"}
...
for name in names_and_emails_dictionary:  # alternatively: names_and_emails_dictionary.keys()
